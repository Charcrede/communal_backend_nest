...
let MediaController = class MediaController {
    ...
    create(createMediaDto, file) {
        if (file) {
            createMediaDto.url = `/uploads/${file.filename}`;
            createMediaDto.filename = file.filename;
            createMediaDto.size = file.size;
            createMediaDto.type = file.mimetype.startsWith('image/') ? media_entity_1.MediaType.IMAGE :
                file.mimetype.startsWith('video/') ? media_entity_1.MediaType.VIDEO : media_entity_1.MediaType.AUDIO;
        }
